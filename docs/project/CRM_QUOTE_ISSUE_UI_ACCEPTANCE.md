# Gate Acceptance — CRM Quote Issue UI
...
- [Architecture Gate](CRM_QUOTE_ISSUE_UI_ARCHITECTURE_GATE.md)
...
| AC-03 | Scope excludes Convert/Confirm/Delivery/Invoice/RA/Hold | Pass |
| AC-04 | Tenant/Permission remain authoritative | Pass |
| AC-05 | Explicit human_confirm retained | Pass |
| AC-06 | Idempotent Issue cannot overwrite | Pass |
