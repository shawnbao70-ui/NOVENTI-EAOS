...
Observe, score, and HOLD dual-write / parallel-fact situations for SO/DO/inventory/Receipt/AR (and adjacent mirrors) through the **Sense/Structure/Score/Dossier** lens — discover and dossier parallel writers without correcting records. Do not edit `docs/knowledge/**` or treat knowledge-pack conclusions as live facts.

## Dual-write / parallel-fact observation points

1. Inventory balance vs product stock mirror after Ship/Sample Receipt
2. SO payment mirrors vs live receipts sum
3. Customer360 (SO−Receipts) vs Statement/ar_records.balance
4. DO status Complete vs ledger Ship rows after Reopen
5. Quote status 已确认 vs Sent/Won vocabulary in reporting extracts
6. Requirement count cache vs actual requirement rows/links
