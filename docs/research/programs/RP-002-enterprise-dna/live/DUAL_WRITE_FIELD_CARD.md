...
Observe, score, and HOLD dual-write / parallel-fact situations for SO/DO/inventory/Receipt/AR (and adjacent mirrors) through the **repeatable behavioral patterns** lens — score only corroborated dual-write patterns, never invent DNA from one path. Do not edit `docs/knowledge/**` or treat knowledge-pack conclusions as live facts.

## Dual-write / parallel-fact observation points

1. Repeated Ship→triple-write (inventory/product/ledger) without single reconciliation owner
2. Repeated Receipt without AR allocation across cases
3. Repeated Convert with missing TC as a tolerated pattern
4. Repeated Reopen that leaves ghost Ship remarks
5. Repeated dual customer balance views in ops vs finance printouts
6. Repeated numbering collision/retry behavior as a cultural workaround
