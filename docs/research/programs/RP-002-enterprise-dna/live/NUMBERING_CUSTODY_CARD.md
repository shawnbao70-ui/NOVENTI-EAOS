...
Observe, score, and HOLD document-number identity, uniqueness, collision, and custody through the **repeatable behavioral patterns** lens — score only repeated numbering/retry patterns corroborated across cases. Do not edit `docs/knowledge/**` or treat knowledge-pack conclusions as live facts.

## Numbering / identity observation points

1. Repeated same-second DO/Quote/Sample creates and operator retries
2. Repeated reliance on app redirect instead of DB unique for SO
3. Repeated manual copy/renumber after collision
4. Repeated dual generator families for the same document class
5. Repeated print/label reprint when numbers are not stable keys
6. Cultural acceptance of duplicate-looking identifiers in reports
