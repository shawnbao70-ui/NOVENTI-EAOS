...
Observe, score, and HOLD dual-write / parallel-fact situations for SO/DO/inventory/Receipt/AR (and adjacent mirrors) through the **operating model** lens — future model must declare multi-writer reconciliation as first-class. Do not edit `docs/knowledge/**` or treat knowledge-pack conclusions as live facts.

## Dual-write / parallel-fact observation points

1. Operating model roles for inventory vs product mirror vs ledger
2. Operating model for Receipt vs AR with explicit non-allocation today
3. Exception model for Reopen/reship/ghost ledger
4. Credit operating model vs actual ungated Convert/Ship
5. Fulfillment model for multi-DO without remaining qty
6. Identity of document numbers as authority vs display under collision
