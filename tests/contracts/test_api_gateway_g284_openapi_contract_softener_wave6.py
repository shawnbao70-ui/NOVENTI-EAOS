"""PHX-G284 Foundation contract softener wave6 honesty."""
...
def test_g284_docs_present() -> None:
    assert (
        ROOT / "docs" / "decisions" / "ADR-0303-foundation-contract-softener-wave6.md"
    ).is_file()
    assert (ROOT / "docs" / "project" / "PHX-G284_ACCEPTANCE.md").is_file()

def test_g284_ops_tip_parity() -> None:
