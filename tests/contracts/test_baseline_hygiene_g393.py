"""PHX-G393 baseline / release hygiene contracts (historical TRACK freeze)."""
...
def test_g393_tip_and_roadmap_track_freeze() -> None:
    ...
    assert "TRACK-G393 COMPLETE" in roadmap
    assert "TRACK-BASELINE-HYGIENE-G393 COMPLETE" in roadmap
